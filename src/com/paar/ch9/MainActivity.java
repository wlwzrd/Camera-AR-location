...
public class MainActivity extends AugmentedActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        BuildingDataSource BData = new BuildingDataSource(this.getResources());
        ARData.addMarkers(BData.getMarkers());
        RestaurantDataSource RData = new RestaurantDataSource(this.getResources());
        ARData.addMarkers(RData.getMarkers());
